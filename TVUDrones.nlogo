   ...
   while [ ticks <= 10000 ][
     ...
     ask formigas [
       ...
       [
         ...
         ; Atualizando o u-value do patch atual
         ; u(s) := max (1 + u(s), 1 + u(succ(s,a)))

         ; A celula atual eh atualizada com o maior valor entre
         ; o u-value da celula atual + 1, e o u-value da celula destino + 1

         let novo-valor [u-value] of sucessor

         ask patch-here [
           set u-value max list (u-value + 1) (novo-valor + 1)
           set plabel u-value
         ]
         move-to sucessor
       ]
...
925
96
The default file name will be TVUResults.csv
12
0.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="Thruns Value Update Rule" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
