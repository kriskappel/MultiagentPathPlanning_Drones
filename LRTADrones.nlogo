...
to go
   ;while [ ticks <= 10000 ][
     ...
     ask formigas [
       ...
       [
         add1-curve-list ;adiciona 1 na lista de curvas geral
         ;add1-curve-list personal-curve-list ;adiciona 1 na lista de curvas do agente
         ...
         let novo-valor [u-value] of sucessor + 1
         ask patch-here [
           set u-value novo-valor
           set plabel u-value
         ]
         move-to sucessor
       ]
...
930
100
The default file name will be LRTAResults.csv
12
0.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="LRTA Star" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
