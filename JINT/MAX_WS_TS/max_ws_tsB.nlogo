...
to calculate-map-matrix
  let dim matrix:dimensions time-matrix

  let matrix matrix:make-constant item 0 dim item 1 dim ticks

  set map-matrix matrix:minus matrix time-matrix
end
