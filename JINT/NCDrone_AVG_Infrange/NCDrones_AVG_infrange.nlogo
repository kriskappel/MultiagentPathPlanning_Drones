...
<experiments>
  ...
  <experiment name="avg_infrange10k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="avg_infrange15k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="avg_infrange20k" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
